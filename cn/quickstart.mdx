...
需要更高编辑精度时可选 `gpt-image-2.5-sunburst`，模型选择见[图像使用指南](/cn/user-guide/gpt-image-2)。2.5 的质量档位、透明输出和参数边界见[图像生成 API](/cn/api-reference/images/gpt-image-2/generation)。
