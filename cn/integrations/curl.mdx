...
JSON 参考图、遮罩和多图示例见[图像编辑](/cn/api-reference/images/gpt-image-2/edits)。请求流式输出时可使用 `--no-buffer`，并根据实际 Content-Type 处理 SSE 或 JSON，见[流式返回](/cn/api-reference/images/streaming)。
