...
`generation.json` 中的 `data[].b64_json` 为图片 base64。[SDK 示例](/cn/integrations/openai-sdk)演示解码保存；[图像编辑](/cn/api-reference/images/gpt-image-2/edits)提供实测文件上传；[流式返回](/cn/api-reference/images/streaming)提供 cURL SSE 示例。
